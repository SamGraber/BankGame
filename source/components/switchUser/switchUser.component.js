System.register(['angular2/core', 'angular2/common', 'angular2/router', '../../services/authentication/authentication.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            SwitchUserComponent = (function () {
                function SwitchUserComponent(authentication, router) {
                ...
                return SwitchUserComponent;
            }());
            exports_1("SwitchUserComponent", SwitchUserComponent);
        }
    }
});
//# sourceMappingURL=switchUser.component.js.map